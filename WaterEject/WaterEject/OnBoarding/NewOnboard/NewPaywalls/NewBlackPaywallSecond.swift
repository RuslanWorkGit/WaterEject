...
struct NewBlackPaywallSecond: View {
    ...
    init(
        ...
        paywallId: String = "paywall_new_black_2"
    ) {
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            ZStack(alignment: .topTrailing) {
                ...
                VStack(spacing: 0) {
                    Image("paywallPhotoNewBlackSecond")
                        .resizable()
                        .scaledToFill()
...
#Preview {
    NewBlackPaywallSecond(onFinish: { print("hello") })
