...
struct NewWhitePaywall: View {
    ...
    init(
        ...
        paywallId: String = "paywall_new_white_1"
    ) {
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(spacing: isSmall ? 10 : 14) {
                            VStack(spacing: 8) {
                                Text("Unlock Full\nCleaning Power")
                                    .font(.system(size: isSmall ? 28 : 34, weight: .black))
                                    .foregroundStyle(.black)
                                    .multilineTextAlignment(.center)
                                    .lineSpacing(-2)

                                Text("Apple Watch Sonic Technology")
                                    .font(.system(size: isSmall ? 18 : 21, weight: .regular))
                                    .foregroundStyle(Color(red: 28 / 255, green: 28 / 255, blue: 30 / 255))
                                    .multilineTextAlignment(.center)
                            }
                        

                            NewWhitePaywallRating()
                                .padding(.top, isSmall ? 0 : 2)

                            HStack(spacing: 14) {
                                NewWhitePaywallPlanCard(
                        ...
                        .font(.system(size: 14, weight: .regular))
                        .foregroundStyle(Color(red: 77 / 255, green: 77 / 255, blue: 77 / 255))
...
private struct NewWhitePaywallRating: View {
    var body: some View {
        HStack(spacing: 4) {
            HStack(spacing: 1) {
...
private struct NewWhitePaywallPlanCard: View {
    let title: String
    let price: String
    let subtitle: String
    let badge: String?
            ...
            ZStack(alignment: .top) {
                ...
                .background(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .fill(isSelected ? Color(red: 212 / 255, green: 235 / 255, blue: 247 / 255) : Color.white)
                )
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .stroke(
...
#Preview {
    NewWhitePaywall(onFinish: { print("hello") })
